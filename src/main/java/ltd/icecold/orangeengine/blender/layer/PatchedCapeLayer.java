...
public class PatchedCapeLayer extends BlenderPatchedLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>, CapeLayer> {
    @Override
    public void renderLayer(AbstractClientPlayer entityliving, CapeLayer originalRenderer, PoseStack matrixStackIn, MultiBufferSource buffer, int packedLightIn, OpenMatrix4f[] poses, float netYawHead, float pitchHead, float partialTicks) {
