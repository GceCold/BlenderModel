...
public class OrangeRenderTypes extends RenderType {
    public OrangeRenderTypes(String p_173178_, VertexFormat p_173179_, VertexFormat.Mode p_173180_, int p_173181_, boolean p_173182_, boolean p_173183_, Runnable p_173184_, Runnable p_173185_) {
    ...
    private static final Function<ResourceLocation, RenderType> ANIMATED_MODEL = Util.memoize((textureLocation) -> {
        ...
        return create("orangeengine" + ":animated_model", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.TRIANGLES, 256, true, false, state);
    });
    ...
    private static final Function<ResourceLocation, RenderType> ANIMATED_ITEM_ENTITY_TRANSLUCENT_CULL = Util.memoize((textureLocation) -> {
        RenderType.CompositeState state = RenderType.CompositeState.builder()
                ...
                .createCompositeState(true);
        return create("orangeengine" + ":animated_item_entity_translucent_cull", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.TRIANGLES, 256, true, true, state);
    });
    ...
    private static final Function<ResourceLocation, RenderType> ANIMATED_ARMOR_CUTOUT_NO_CULL = Util.memoize((p_173206_) -> {
        ...
        return create("orangeengine" + ":armor_cutout_no_cull", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.TRIANGLES, 256, true, false, rendertype$compositestate);
    });
    ...
    private static final Function<ResourceLocation, RenderType> ANIMATED_ARMOR_TRANSLUCENT_CUTOUT_NO_CULL = Util.memoize((p_173206_) -> {
        RenderType.CompositeState rendertype$compositestate = RenderType.CompositeState.builder()
                ...
                .setOverlayState(OVERLAY).setLayeringState(VIEW_OFFSET_Z_LAYERING).createCompositeState(true);
        return create("orangeengine" + ":armor_cutout_no_cull", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.TRIANGLES, 256, true, true, rendertype$compositestate);
    });

    private static final RenderType ANIMATED_ARMOR_GLINT = create("orangeengine" + ":animated_armor_glint", DefaultVertexFormat.POSITION_TEX, VertexFormat.Mode.TRIANGLES, 256, false, false,
    ...
    private static final Function<ResourceLocation, RenderType> ENTITY_INDICATOR = Util.memoize((textureLocation) -> {
        RenderType.CompositeState state = RenderType.CompositeState.builder()
                ...
                .createCompositeState(true);
        return create("orangeengine" + ":entity_indicator", DefaultVertexFormat.POSITION_TEX, VertexFormat.Mode.QUADS, 256, true, false, state);
    });
    ...
    private static final Function<ResourceLocation, RenderType> ENTITY_DECAL_TRIANGLES = Util.memoize((p_173194_) -> {
        RenderType.CompositeState state = RenderType.CompositeState.builder()
                ...
                .setOverlayState(OVERLAY)
                .createCompositeState(false);
        return create("orangeengine" + ":entity_decal_triangles", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.TRIANGLES, 256, false, false, state);
    });
    ...
    private static final Function<ResourceLocation, RenderType> DRAGON_EXPLOSION_ALPHA_TRIANGLES = Util.memoize((textureLocation) -> {
        RenderType.CompositeState state = RenderType.CompositeState.builder()
                ...
                .setCullState(NO_CULL)
                .createCompositeState(true);
        return create("orangeengine" + ":dragon_explosion_triangles", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.TRIANGLES, 256, false, false, state);
    });

    private static final RenderType DEBUG_COLLIDER = create("orangeengine" + ":debug_collider", DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.LINE_STRIP, 256, false, false,
            RenderType.CompositeState.builder()
    ...
    private static final RenderType DEBUG_QUADS = create("orangeengine" + ":debug_quad", DefaultVertexFormat.POSITION_COLOR, VertexFormat.Mode.QUADS, 256, false, false,
            RenderType.CompositeState.builder()
    ...
    public static RenderType energySwirlTrianlges(ResourceLocation texture, float u, float v) {
        return create("orangeengine" + ":energy_swirl_trianlges", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.TRIANGLES, 256, false, true, RenderType.CompositeState.builder()
    ...
    public static RenderType entityTranslucentTriangles(ResourceLocation texture) {
        return create("orangeengine" + ":entity_transparent", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.TRIANGLES, 256, false, true, RenderType.CompositeState.builder()
